...
namespace Steam_Achievement_Abuser_Loop
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            Console.Title = "Steam Achievement Abuser Loop | Breno Farias da Silva";
            Console.WriteLine("Starting Steam Achievement Abuser in looped automatic mode...");
            ...
            // Continuous loop: run StartAbuse, wait 1 hour, repeat
            while (true)
            {
                try
                {
        ...
        {
            Console.WriteLine("Starting abuse (loop)...");
            int i = 1;
